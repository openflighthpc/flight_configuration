# Contributing to FlightConfiguration

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to FlightConfiguration? Welcome! Please read this
...
You can help FlightConfiguration by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight_configuration/issues?state=open)
...
If you find a bug - behaviour of FlightConfiguration code or documentation
...
[GitHub issue tracker for FlightConfiguration](https://github.com/openflighthpc/flight_configuration/issues/new)
to report the issue.
...
We want to improve the quality of FlightConfiguration and good bug reports are
...
FlightConfiguration is Open Source and comes without warranty.
...
FlightConfiguration in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of FlightConfiguration and really improve it. The more
...
applied to FlightConfiguration itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight_configuration). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the FlightConfiguration developers also have their regular
